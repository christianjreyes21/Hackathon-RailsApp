			...
			<div class="row">
				...
				<div class="col-sm-8">
					<div class="row">
						...
						<div class="col-sm-2">
							<div id="LegendCircle1" style="display: inline-block; margin-left: 10px; width:15px; height:25px;"></div> <font style="display: inline-block;font-size:20px;"> &nbsp;North Bound</font>
						</div>
						<div class="col-sm-2">
							<div id="LegendCircle2" style="display: inline-block; margin-left: 10px; width:15px; height:25px;"></div> <font style="display: inline-block;font-size:20px;"> &nbsp;South Bound</font> 
						</div>
						<div class="col-sm-1"></div>
						<br/><br/>
					</div>
